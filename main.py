...
driver.get("https://airport.by/raspisanie-rejsov/prilety")
block = driver.find_elements(By.XPATH, "//tbody")
print(block)

pril_1 = driver.find_elements(By.XPATH, '//tr[@class="flights-item flights-item--special green"]')
pril_2 = driver.find_elements(By.XPATH, '//tr[@class="flights-item flights-item--special"]')

text_arive_nigrt = 'Ночные прилеты:\n'
text_arive_day = 'Дневные прилеты:\n'
for i in pril_1:
...
for i in pril_2:
    ...
    if where not in non_list and time[0:2] in night:
        text_arive_nigrt+=f'{where} {time}:\n'
